...
const SectionList = ({ projectId, onSelectSection, selectedSection, isAdmin }) => {
  ...
  useEffect(() => {
    ...
    setSections([
      ...
      { id: 5, title: 'Brand Strategy', status: 'To Do', parent_section_id: null },
      { id: 6, title: 'Planner', status: 'To Do', parent_section_id: null },
      { id: 7, title: 'Brand Story', status: 'To Do', parent_section_id: null },
      { id: 8, title: 'Moodboard', status: 'To Do', parent_section_id: null },
      { id: 9, title: 'Concept & Direction', status: 'To Do', parent_section_id: null },
      { id: 10, title: 'Logo', status: 'To Do', parent_section_id: 9 },
      { id: 11, title: 'Typography', status: 'To Do', parent_section_id: 9 },
      { id: 12, title: 'Colour', status: 'To Do', parent_section_id: 9 },
      { id: 13, title: 'Illustration', status: 'To Do', parent_section_id: 9 },
      { id: 14, title: 'Icon', status: 'To Do', parent_section_id: 9 },
      { id: 15, title: 'Delivery', status: 'To Do', parent_section_id: null },
    ]);
  }, [projectId]);
